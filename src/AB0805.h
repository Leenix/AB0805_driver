...
enum AB08x5_CALIBRATION_MODE {
    AB08x5_CALIBRATION_2PPM = 0,
    AB08x5_CALIBRATION_4PPM = 1,
};

enum AB08x5_EXTI_POLARITY {
    AB08x5_EXTI_FALLING = 0,
    AB08x5_EXTI_RISING = 1,
};

enum AB08x5_ALARM_TRIGGER_MODE {
...
enum AB08x5_CONFIG_KEY {
    AB08x5_CONFIG_KEY_UNLOCK_OSC_CONTROL = 0xA1,
    AB08x5_CONFIG_KEY_SOFTWARE_RESET = 0x3C,
    AB08x5_CONFIG_KEY_UNLOCK_BATTERY_CONTROL = 0x9D,
};
