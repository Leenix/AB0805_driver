...
void AB08x5::write(ab08x5_exti_polarity_t config) { write((uint8_t *)&config, AB08x5_REGISTER::INT_POLARITY); }

void AB08x5::write(ab08x5_trickle_config_t config) { write((uint8_t *)&config, AB08x5_REGISTER::TRICKLE); }

void AB08x5::write(ab08x5_output_control_t config) { write((uint8_t *)&config, AB08x5_REGISTER::O_CONTROL); }
...
void AB08x5::read(ab08x5_exti_polarity_t &config) { read((uint8_t *)&config, AB08x5_REGISTER::INT_POLARITY); }

void AB08x5::read(ab08x5_trickle_config_t &config) { read((uint8_t *)&config, AB08x5_REGISTER::TRICKLE); }

void AB08x5::read(ab08x5_output_control_t &config) { read((uint8_t *)&config, AB08x5_REGISTER::O_CONTROL); }
///////////////////////////////////////////////////////////////////////////////
